        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold py-3.5 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-blue-600/25"
            >
              <Send size={16} />
              Send Message
            </a>
